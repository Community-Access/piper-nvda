...
```
certutil -hashfile dist\piper-neural-1.0.0.nvda-addon SHA256
```

## Step 3: publish the file

Create a GitHub release (tag it, e.g. `v1.0.0`) and attach the
...
| `addonVersionName` | the version string, e.g. `1.0.0` |
